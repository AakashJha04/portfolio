    ...
    text-white'>
      ...
      max-w-screen-lg mx-auto h-full">
        <div className='pb-8'>
            ...
            <p className='py-6'>Please ,Submit the form below to Contact me</p>
        </div>

        <div className='flex justify-center items-center'>
            <form action="https://getform.io/f/pamqyrxa" method="POST" className='flex flex-col w-full md:w-1/2'>
                ...
                rows="10"
                className="p-2 bg-trasparent border-2 rounded-md
